          ...
          >
            ...
            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                ...
                Имаме над <span className="text-blue-400 font-semibold">5 години</span> опит и няколкото стотин успешно внесени автомобила. 
                Най-добрата ни реклама са доволните клиент.
              </p>
              <p>
                Нашият екип от професионалисти се грижи за всеки детайл от процеса - от избора на автомобила,
                през проверката и покупката, до транспорта и митническото оформяне. Работим изключително с проверени
                търгове и утвърдени дилъри в САЩ и Канада, за да гарантираме качеството и произхода на всеки автомобил.
              </p>
              <p>
                Основният ни фокус е вносът от Северна Америка, където познаваме пазара в дълбочина и имаме изградени процеси и партньорства.
                При конкретен интерес от страна на клиента, приемаме и индивидуални поръчки за автомобили от Европа, като услугата се предлага след предварително запитване и уточняване на условията.
              </p>
              <p>
                Вярваме в <span className="text-blue-400 font-semibold">прозрачност, професионализъм и качество</span>.
                Всеки наш клиент получава пълна информация и лична поддръжка през целия процес на внос.
              </p>
            </div>
